...
beforeEach(async () => {
  ...
  await request.post("/api/users").send(user).expect(201);
  ...
  console.log(
    "tokenuiiiiiiiuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu",
    token,
  );
});
